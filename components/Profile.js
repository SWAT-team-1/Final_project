         ...
         :
                ...
                <div className="w-full h-64 mx-2 md:w-9/12">
                    ...
                    <div className="relative p-8 bg-white shadow-sm sm:rounded-xl">
                        <form className="w-full" onSubmit={CreateReview}>
                            ...
                            <button type='submit' className="block w-full p-3 my-4 text-sm font-semibold text-blue-800 rounded-lg hover:bg-gray-100 focus:outline-none focus:shadow-outline focus:bg-gray-100 hover:shadow-xs">Add</button>
                        </form>
